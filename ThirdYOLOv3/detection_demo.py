...
image_path   = "./IMAGES/maksssksksss12.png"
# video_path   = "./IMAGES/test.mp4"

yolo = Load_Yolo_model()
detect_image(yolo, image_path, "./IMAGES/maksssksksss12.png", input_size=YOLO_INPUT_SIZE, show=True, rectangle_colors=(255,0,0))
