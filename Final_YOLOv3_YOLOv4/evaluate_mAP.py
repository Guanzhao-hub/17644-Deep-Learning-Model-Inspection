...
def get_mAP(Yolo, dataset, score_threshold=0.25, iou_threshold=0.50, TEST_INPUT_SIZE=TEST_INPUT_SIZE):
    ...
    with open("mAP/results_iou{}.txt".format(iou_threshold), 'w') as results_file:
        ...
        for class_index, class_name in enumerate(gt_classes):
            ...
            results_file.write(
                text + "\n Average Precision: " + str(average_prec) + "\n Average Recall   :" + str(
                    average_rec) + "\n\n")
            print(text)
...
if __name__ == '__main__':
    ...
    get_mAP(yolo, testset, score_threshold=0.05, iou_threshold=0.65, TEST_INPUT_SIZE=YOLO_INPUT_SIZE)
