...
YOLO_CUSTOM_WEIGHTS         = f"{YOLO_TYPE}_custom" # "checkpoints/yolov3_custom" # used in evaluate_mAP.py and custom model detection, if not using leave False
...
TRAIN_CLASSES               = "model_data/mask/mask.names"
TRAIN_ANNOT_PATH            = "model_data/mask/mask_train.txt"
TRAIN_LOGDIR                = "log"
...
# TEST options
TEST_ANNOT_PATH             = "model_data/mask/mask_test.txt"
TEST_BATCH_SIZE             = 4
TEST_INPUT_SIZE             = 416
TEST_DATA_AUG               = False
